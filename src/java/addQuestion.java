...
public class addQuestion extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            String addMainQuestion = "INSERT INTO main_question (questionNumber, sequence, paperID) VALUES ('" + questionNo + "', '" + (questionCount + 1) + "', '" + examPaperID + "');";
            stmt.executeUpdate(addMainQuestion);
