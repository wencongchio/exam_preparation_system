 ...
 * @author User
 */
@WebServlet(urlPatterns = {"/addSubQuestion"})
public class addSubQuestion extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            String addSubQuestion = "INSERT INTO sub_question (mainQuestionID, sequence, paperID) VALUES ('" + questionID + "', '" + (questionCount + 1) + "', '" + examPaperID + "');";
            stmt.executeUpdate(addSubQuestion);
