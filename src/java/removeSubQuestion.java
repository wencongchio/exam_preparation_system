 ...
 * @author User
 */
@WebServlet(urlPatterns = {"/removeSubQuestion"})
public class removeSubQuestion extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String sql = "SELECT COUNT(*) FROM sub_question WHERE mainQuestionID = '" + questionID + "';";
            ...
            if (questionCount > 0) {
                String removeSubQuestion = "DELETE FROM sub_question WHERE mainQuestionID = '" + questionID + "' AND paperID = '" + examPaperID + "' AND sequence = '" + questionCount + "';";
                stmt.executeUpdate(removeSubQuestion);
